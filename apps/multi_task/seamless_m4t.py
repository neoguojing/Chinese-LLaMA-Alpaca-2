...
class SeamlessM4t(CustomerLLM):
    ...
    def __init__(self, model_path: str = os.path.join(model_root,"seamless-m4t"),**kwargs):
        ...
        self.processor = AutoProcessor.from_pretrained("facebook/hf-seamless-m4t-medium",cache_dir=os.path.join(model_root,"seamless-m4t"))
        self.model = SeamlessM4TModel.from_pretrained("facebook/hf-seamless-m4t-medium",cache_dir=os.path.join(model_root,"seamless-m4t"))
